...
namespace MxPlot.UI.Avalonia.Helpers
{
    ...
    /// as monochrome under Avalonia's Skia text pipeline. All paths use a 24×24
    /// coordinate space and scale automatically via <see cref="Avalonia.Controls.PathIcon"/>.
    /// <para>Provenance is recorded per icon by a one-line comment above each declaration:
    /// most come from Material Design Icons (Apache 2.0), either verbatim or modified, and
    /// the rest are drawn here. See this project's THIRD-PARTY-NOTICES.txt for the full
    /// per-icon breakdown and the license text; keep both in sync when icons change.</para>
    /// </summary>
    internal static class MenuIcons
    {
        ...
        // From MDI "book-variant-multiple" - frame kept, inner shape replaced
        ...
        /// <summary>Copy-with-lines icon (Material Design "content-copy" body plus text-line
        /// detail) for "Copy Data" — distinguishes a data/text copy from the plain <see cref="Copy"/>
        /// glyph. 24×24 coordinate space.</summary>
        // From MDI "content-copy" - text lines added
        internal static readonly StreamGeometry CopyData = StreamGeometry.Parse(
            "M16,1H4C2.9,1 2,1.9 2,3V17H4V3H16V1M19,5H8C6.9,5 6,5.9 6,7V21C6,22.1 6.9,23 8,23H19C20.1,23 21,22.1 21,21V7C21,5.9 20.1,5 19,5M19,21H8V7H19V21M17,19H10V17H17V19M17,15H10V13H17V15M17,11H10V9H17V11Z");
        ...
        // From MDI "cube-outline" - plus badge added
        ...
        // From MDI "palette-outline" - body verbatim, the four dots redrawn as arcs
        ...
        // MDI "magnify" (verbatim)
        internal static readonly StreamGeometry Magnify = StreamGeometry.Parse(
            "M9.5,3A6.5,6.5 0 0,1 16,9.5C16,11.11 15.41,12.59 14.44,13.73L14.71,14H15.5L20.5,19L19,20.5L14,15.5V14.71L13.73,14.44C12.59,15.41 11.11,16 9.5,16A6.5,6.5 0 0,1 3,9.5A6.5,6.5 0 0,1 9.5,3M9.5,5C7,5 5,7 5,9.5C5,12 7,14 9.5,14C12,14 14,12 14,9.5C14,7 12,5 9.5,5Z");

        /// <summary>Bounding min/max bars with an expand arrow between them, for "Find Min/Max"
        /// (set the value range to a region's min/max). Hand-crafted. 24×24 coordinate space.</summary>
        // Original - no upstream match
        internal static readonly StreamGeometry FindMinMax = StreamGeometry.Parse(
            "M4,2 H20 V4 H4 Z M4,20 H20 V22 H4 Z M12,6 L16,10 H13 V14 H16 L12,18 L8,14 H11 V10 H8 Z");

        // ── Controls ──────────────────────────────────────────────────────────

        // MDI "cube-outline" (verbatim)
        ...
        // From MDI "cog"/"cog-outline" - ring and body combined
        ...
        // From MDI "auto-fix" - lower sparkle moved down
        ...
        /// <summary>Crop-marks / viewfinder icon (two overlapping corner guides) for the "Crop"
        /// action, replacing the generic <see cref="AutoFix"/> placeholder there specifically
        /// (Material Design "crop", Apache 2.0). 24×24 coordinate space.</summary>
        // From MDI "crop" - subpaths reordered, one arc rewritten as a curve
        internal static readonly StreamGeometry Crop = StreamGeometry.Parse(
            "M17,15H19V7C19,5.89 18.1,5 17,5H9V7H17V15M7,17V1H5V5H1V7H5V17C5,18.1 5.89,19 7,19H17V23H19V19H23V17H7Z");

        // From MDI "undo" - two control points nudged
        ...
        // MDI "trash-can-outline" (verbatim)
        ...
        // From MDI "eye-off" - slash endpoints nudged
        ...
        // From MDI "sine-wave" - coordinates rounded
        ...
        // From MDI "cube-outline" - right face removed
        ...
        // From MDI "cube-outline" - left face removed
        ...
        /// </summary>
        // From MDI "checkbox-marked" - square and checkmark merged for even-odd fill
        ...
        /// </summary>
        // From MDI "checkbox-blank-outline" - arcs rewritten as curves
        ...
        /// <summary>Puzzle-piece icon for the Plugins tab (Material Design Icons "puzzle", Apache 2.0).</summary>
        // From MDI "puzzle" - curves rewritten as arcs
        ...
        /// <summary>Line-chart icon for "Plot Profile" actions (Material Design Icons "chart-line-variant", Apache 2.0).</summary>
        // From MDI "chart-line-variant" - coordinates nudged
        ...
        // From MDI "history" - closing Z added
        ...
        /// <summary>Table/grid icon for the Data menu. 24×24 coordinate space.</summary>
        // From MDI "chart-box" - box frame only, grid drawn here
        ...
        private static readonly Dictionary<StreamGeometry, IBrush> _defaultBrushes = new()
        {
            ...
            [CopyData] = new SolidColorBrush(Color.Parse("#78909C")),  // Blue Grey 400
            ...
            // Matches ValueRangeBar's Min/Max "seek" button icon color (SearchEnabledBrush),
            // so Find Min/Max reads as the same action wherever it appears.
            ...
            // Amber 700, not the crop ROI's plain Colors.Yellow (#FFFF00) accent it echoes --
            // pure yellow reads as barely-there against a light menu background.
            [Crop] = new SolidColorBrush(Color.Parse("#FFA000")),  // Amber 700
