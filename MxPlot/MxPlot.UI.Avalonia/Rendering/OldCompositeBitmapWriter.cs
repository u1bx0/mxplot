...
namespace MxPlot.UI.Avalonia.Rendering
{
    ...
    /// </summary>
    public class OldCompositeBitmapWriter
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OldCompositeBitmapWriter"/> class for the specified value type.
        /// </summary>
        public OldCompositeBitmapWriter(Type type)
        {
            ...
            global::Avalonia.Vector dpi = default)
        {
            ...
            var writer = new OldCompositeBitmapWriter(source.ValueType);
